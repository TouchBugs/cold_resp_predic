...
def main():
    # 参数设置
    file_path = '/Data4/gly_wkdir/coldgenepredict/raw_sec/S_italica/分好的数据集csv/sbcolor.csv'  
    ...
    for i, batch in enumerate(dataloader):
        i = i + 135
        with open(f'/Data4/gly_wkdir/coldgenepredict/raw_sec/S_italica/分好的数据集csv/二进制GRU/排序好/sbicolor/train_batch_{i}.pkl', 'wb') as f:
            pickle.dump(batch, f)
