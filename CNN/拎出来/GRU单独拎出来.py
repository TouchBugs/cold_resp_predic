...
import yaml
from GRU模型单独拎出来 import bcolors, SimpleGRU
import torch
import time
...
parser.add_argument('-加载GRU参数', type=int, default=1, help='加载GRU参数')
# 设置随机种子
seed = 3407
...
加载GRU参数 = args.加载GRU参数
# =============================================
# 打印出所有超参数
print(f'lr: {lr}\nweight_decay: {weight_decay}\nfreeze_GRU: {freeze_GRU}\nthreathhold: {threathhold}\nhidden_size2: {hidden_size2}\nhidden_size3: {hidden_size3}\nepoch: {epochs}\n加载GRU参数: {加载GRU参数}\n')

Thetarget = f'{freeze_GRU}排序128加dp-{threathhold}'
print(Thetarget)

best_acc = 0.7
root_dir = '/Data4/gly_wkdir/coldgenepredict/raw_sec/S_italica/CNN/拎出来/'
