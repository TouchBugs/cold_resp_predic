...
cold_responsive_genes = read_genes('/Data4/gly_wkdir/coldgenepredict/raw_sec/S_italica/分好的数据集csv/Gm/cold_responsive_genes.csv', 1)
nonresponsive_genes = read_genes('/Data4/gly_wkdir/coldgenepredict/raw_sec/S_italica/分好的数据集csv/Gm/nonresponsive_genes.csv', 0)
...
gene_to_locus = parse_gff('/Data4/gly_wkdir/coldgenepredict/raw_sec/S_italica/分好的数据集csv/Gm/Gmax_508_Wm82.a4.v1.gene.gff3')
...
sequences = extract_sequence('/Data4/gly_wkdir/coldgenepredict/raw_sec/S_italica/分好的数据集csv/Gm/Gmax_508_v4.0.fa', gene_to_locus)

# 步骤4: 写入新的CSV文件
with open('/Data4/gly_wkdir/coldgenepredict/raw_sec/S_italica/分好的数据集csv/Gm/data.csv', 'w', newline='') as csvfile:
