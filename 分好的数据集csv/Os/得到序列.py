...
cold_responsive_genes = read_genes('/Data4/gly_wkdir/coldgenepredict/raw_sec/S_italica/分好的数据集csv/Os/cold_responsive_genes.csv', 1)
nonresponsive_genes = read_genes('/Data4/gly_wkdir/coldgenepredict/raw_sec/S_italica/分好的数据集csv/Os/nonresponsive_genes.csv', 0)
...
gene_to_locus = parse_gff('/Data4/gly_wkdir/coldgenepredict/raw_sec/S_italica/分好的数据集csv/Os/Oryza_sativa.IRGSP-1.0.59.chr.gff3')
...
sequences = extract_sequence('/Data4/gly_wkdir/coldgenepredict/raw_sec/S_italica/分好的数据集csv/Os/Oryza_sativa.IRGSP-1.0.dna.toplevel.fa', gene_to_locus)

# 步骤4: 写入新的CSV文件
with open('/Data4/gly_wkdir/coldgenepredict/raw_sec/S_italica/分好的数据集csv/Os/data.csv', 'w', newline='') as csvfile:
