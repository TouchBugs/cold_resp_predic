...
# 保存图片的名字
# 给一个二进制数据集路径
train_data_dir = f'/Data4/gly_wkdir/coldgenepredict/raw_sec/S_italica/分好的数据集csv/{databasename}/train/'
val_data_dir = f'/Data4/gly_wkdir/coldgenepredict/raw_sec/S_italica/分好的数据集csv/{databasename}/val/'
# 给一个二进制Data数据集保存路径
train_save_dir = f'/Data4/gly_wkdir/coldgenepredict/raw_sec/S_italica/分好的数据集csv/二进制一位分批数据集/Data/train64/'
val_save_dir = f'/Data4/gly_wkdir/coldgenepredict/raw_sec/S_italica/分好的数据集csv/二进制一位分批数据集/Data/val/'
...
for epoch in range(1):
    ...
    for i in range(184):
        with open(train_data_dir+'train_batch_'+str(i)+'.pkl', 'rb') as f:
            ...
            # --------------------------------------------------------------------------------------
            # 将Data对象保存到文件中
            with open(train_save_dir+'train_batch64_'+str(i)+'.pkl', 'wb') as f:
                pickle.dump(data, f)
